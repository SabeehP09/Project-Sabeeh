...
Place all required screenshots here before embedding them into the project report.
...
- Highlight important values with red boxes or arrows.
- Ensure text is readable when printed.

See `docs/screenshot-guide.md` for detailed capture instructions.
